...
for filename in os.scandir(directory):
    if filename.is_file():
        ...
        output_img, flag, cloud_factor, x, y, bad_calibration = segmentation(input_name, ret_coords=True)

        sun_data[name] = {'sun':flag, 'coords':[x,y], 'cloud_factor':cloud_factor}
...
# Save updated sun_data to JSON
with open(sun_data_file, 'w', encoding='utf-8') as f:
    json.dump(sun_data, f, ensure_ascii=False, indent=4)
