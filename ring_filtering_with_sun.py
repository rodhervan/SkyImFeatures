...
# Given data
x_m = np.array([136.035, 175.367, 203.438, 257.167, 286.813, 349.703, 391.018, 420.325, 424.707, 459.474])
y_m = np.array([271.47, 257.643, 253.745, 251.655, 252.244, 256.478, 261.768, 267.484, 268.554, 280.672])

# Real data
x_real = np.array([128, 170, 202, 257, 286, 349, 390.5, 422, 424, 466.5])
y_real = np.array([271, 257, 253.745, 251.655, 252.244, 256.478, 261.768, 267.484, 268.554, 280.672])
...
new_solar_x = poly_x(solar_x) + 5
new_solar_y = poly_y(solar_y) + 1.5
